...
class RecordData(object):
    ...
    def __init__(self, params):
        ...
        self.successNum = 0
        self.params = params
        self.totalDetected = 0
        
        
    def rec(self,params, detected_success, totalDetected):
    ...
    def toString(self):
        ...
        buf += "Detected %d our of %d targets\n" % (self.totalDetected, self.params.simulations * self.params.target_num )
